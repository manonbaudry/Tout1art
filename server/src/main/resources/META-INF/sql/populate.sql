...
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('miroir',	 'Un miroir moderne',	'images/miroir.png',	'10.5',	 '1',	 'deco',	'miroir',	'0','3');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('lampe',	 'Une lampe moderne',	'images/vue-principale.jpg',	'10.5',	 '1',	 'luminaire',	'lampe',	'0','3');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('lampe',	 'Une lampe design',	'images/vue3.jpg',	'10.5',	 '1',	 'luminaire',	'lampe',	'0','3');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('chaise simple',	 'Une chaise simple',	'images/chaise2.png',		'10.5',	 '1',	 'mobilier',	'chaise',	'0', '1');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('chaise moderne',	 'Une chaise moderne',	'images/chaise.png',		'150',	 '1',	 'mobilier',	'chaise',	'0', '1');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('lampe',	 'Une lampe simple',	'images/lampe.png',		'120',	 '1',	 'luminaire',	'lampe',	'0', '1');
INSERT INTO produit (nom, description, srcImage, prix, idArtisan, categorie, sousCategorie, commande, delai) VALUES ('lampe',	 'Une chaise simple',	'images/chaise.jpg',	'10.5',	 '1',	 'mobilier',	'chaise',	'0','3');
